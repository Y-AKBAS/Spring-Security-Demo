...
Because of the above mentioned situation a created this repository as of 12.01.2023 for those who cannot find many up to date resources in the internet
which shows the modern way of implementing Spring Security in their applications.

The repository provides some minimalistic examples about how to configure your HttpSecurity, how to create your custom AuthenticationProviders, your custom Filters.
